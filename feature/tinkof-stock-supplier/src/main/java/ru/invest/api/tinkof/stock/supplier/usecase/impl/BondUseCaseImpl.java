package ru.invest.api.tinkof.stock.supplier.usecase.impl;
...
import ru.invest.api.tinkof.stock.supplier.mapper.BondMapper;
import ru.invest.api.tinkof.stock.supplier.usecase.BondRetrieverUseCase;
import ru.invest.api.tinkof.stock.supplier.usecase.BondUseCase;
import ru.invest.api.tinkof.stock.supplier.usecase.PriceUseCase;
...
import static ru.invest.api.tinkof.stock.supplier.predicates.BondPredicates.FOREIGN_CURRENCY_PREDICATE;
import static ru.invest.api.tinkof.stock.supplier.predicates.BondPredicates.ISIN_PREDICATE;
